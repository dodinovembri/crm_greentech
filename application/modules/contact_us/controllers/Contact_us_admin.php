...
class Contact_us_admin extends Admin_Controller 
{
	...
	{   
        ...
        $data['page_description'] = 'Contact Us List';
        $data['message'] = $this->session->flashdata('message');
        $data['dt_users'] = $this->contact_us_model->_datatable_index();
    ...
    {    
        ...
        if($this->contact_us_model->_delete($id))
        {
            $this->session->set_flashdata('message', 'Delete Contact Us success!');
        }
        else
        {
