      ...
      <div class="col-sm-12">
        <div class="box box-success">
          <div class="box-header with-border">
            <h3 class="box-title">Table: Contact Us</h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
              ...
              <div class="row">
                <div class="col-sm-12">
                  <table id="usersTable" class="table table-bordered table-striped dataTable">
                    ...
                    {
                      echo '<tr>' .PHP_EOL;
                        echo '<td>'.$dt['fname'].'</td>' .PHP_EOL;
                        echo '<td>'.$dt['lname'].'</td>' .PHP_EOL;
                        ...
                        <a href="'.site_url('admin/contact_us/delete/'.$dt['id']).'" data-skin="skin-red" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i></a>'.PHP_EOL.'
                        </td>'.PHP_EOL;
                      echo '</tr>' .PHP_EOL;
                    }
                     ?>
